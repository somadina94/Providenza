    ...
    return (
        <Fragment>
            <Helmet>
                ...
                <link rel="canonical" href="/borrowing" />
            </Helmet>
            <section className={classes.borrowing}>
                ...
                <div className={classes.description}>
                    ...
                    <p>
                        Always know what you'll have to pay with fixed monthly repayments spread over 1 to 5 years for
                        loans of €15,000 or less, or over 1 to 8 years for loans over €15,000
                    </p>
                </div>
                <div className={classes.description}>
                ...
                <div className={classes.description}>
                    ...
                    <p>
                        ...
                        application has been approved and the loan agreement has been signed. Non-Providenza premier
                        account customers could receive the money into a nominated account 3 working days after the
                        signed loan agreement is received.
                    </p>
                </div>
                <div className={classes.description}>
                    <h2>Make overpayments free of charge</h2>
                    <p>
                        Manage your finances the way you want with the flexibility to overpay, which could reduce the
