            ...
            <section className={classes.insurance}>
                ...
                <div className={classes.description}>
                    ...
                    <p>
                        ...
                        Breakdown cover. You can then make changes to your policy each year, as long as you keep a
                        minimum of 3 types of cover.
                    </p>
                </div>
                <div className={classes.description}>
                    <h2>Get cover for you and your family</h2>
                    <p>
                        Relax knowing your family will be covered, including your partner and any children under 18 who
                        live with you. Plus, any children under 23 who are in full-time education, but are at home
